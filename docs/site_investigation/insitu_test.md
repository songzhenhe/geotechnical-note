...
The vane is then rotated at a speed which can be adjusted from 0.1� per second up to 15� per second, while the sampling rate can be user defined.

Upon completion of the undrained shear test, the user can easily start a remould test. The vane will be turned 5 revolutions at a speed of 15� per second. 
